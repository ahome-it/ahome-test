...
public class LMContainer extends Container
{
    public LMContainer()
    {
    ...
    public LMContainer(ContainerLayout layout)
    {
        this();
    ...
    public LMContainer(Layout layout)
    {
        this();
    ...
    public LMContainer(String title)
    {
        this();
    ...
    public LMContainer(String title, ContainerLayout layout)
    {
        this();
    ...
    public LMContainer(String title, Layout layout)
    {
        this();
